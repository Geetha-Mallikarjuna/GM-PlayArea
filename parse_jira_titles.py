...
def write_markdown_table(details_list, output_file):
    ...
    with open(output_file, 'w') as f:
        ...
        f.write("th:nth-child(2), td:nth-child(2) { width: 10%; }\n")
        f.write("th:nth-child(3), td:nth-child(3) { width: 10%; }\n")
        f.write("th:nth-child(4), td:nth-child(4), th:nth-child(5), td:nth-child(2) { width: 25%; word-break: break-word; }\n")
        f.write("</style>\n")
        f.write("<table>\n")
